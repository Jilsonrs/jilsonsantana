...
---
> **Changelog — só as 3 entradas mais recentes ficam aqui.** O histórico completo (Jun 2026 → Ago 2026 (5), 13 entradas, verbatim) está em [`docs/decisions-archive.md`](docs/decisions-archive.md) — consulta sob demanda, **não** carregado por sessão. Ao adicionar uma entrada nova, mova a mais antiga daqui para lá.
