...
projetos ativos.** *O projeto está criado e vazio — migrations e seed continuam pendentes
(`implementation-plan.md` → Fase 4, pré-requisito de separação de ambientes).*

---

## Changelog histórico do plano (Jun 2026 → Ago 2026 (5))

*(Texto preservado integralmente. As 3 entradas mais recentes — Ago 2026 (6), (7) e (8) — seguem no
