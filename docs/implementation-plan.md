...
> ⚠️ **Supabase mantido ligado como rollback** (`gaxmbnhwltljlkukdwba`, intocado, somente leitura
> durante toda a migração). **A apagar por decisão do operador ~1 semana após Set 2026.**
>
