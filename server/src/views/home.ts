...
<head>
  ...
  <meta name="description" content="${escapeHtml(dict.home.hero.subtitle)}">
  ...
  <meta property="og:description" content="${escapeHtml(dict.home.hero.subtitle)}">
...
<body>
<!-- 0. Header / Nav -->
  <nav class="navbar" aria-label="${escapeHtml(dict.common.a11y.mainNav)}">
  ...
  <main id="conteudo-principal">
    ...
    <section class="hero container" aria-label="${escapeHtml(dict.home.a11y.hero)}">
      <h1>${escapeHtml(dict.home.hero.titlePrefix)} <span class="emphasis">${escapeHtml(dict.home.hero.titleEmphasis)}</span> ${escapeHtml(dict.home.hero.titleSuffix)}</h1>
      <p>${escapeHtml(dict.home.hero.subtitle)}</p>
      ...
      ${featuredCourse ? ((f) => `<div class="apple-card horizontal reveal-on-scroll" style="margin-top: 80px; margin-bottom: 0;">
        <div class="apple-card-content">
          <span class="tag tag-blue" style="margin-bottom: 16px;">${escapeHtml(dict.home.hero.featuredBadge)}</span>
          <div class="course-badges" aria-label="${escapeHtml(dict.home.a11y.courseBadges)}">
          ...
          <a href="/curso/${escapeHtml(f.slug)}" aria-label="${escapeHtml(f.title)}"
            ...
            onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">${escapeHtml(dict.home.hero.accessCourse)}<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <!-- 2. ${escapeHtml(dict.common.nav.cursos)} -->
    <section id="cursos" class="section container" aria-label="${escapeHtml(dict.home.a11y.catalog)}">
      <div class="section-header reveal-on-scroll">
        <h2>${escapeHtml(dict.home.catalog.titlePrefix)} <span style="color: var(--brand-blue);">${escapeHtml(dict.home.catalog.titleEmphasis)}</span> ${escapeHtml(dict.home.catalog.titleSuffix)}</h2>
        <p>${escapeHtml(dict.home.catalog.subtitle)}</p>
      </div>
...
${courses.map((c) => `
          <div class="course-card reveal-on-scroll">
            ...
            <div class="course-card-content">
              ...
              <a href="/curso/${escapeHtml(c.slug)}" aria-label="${escapeHtml(dict.home.catalog.accessCourse)} ${escapeHtml(c.title)}"
                ...
                onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">${escapeHtml(dict.home.catalog.accessCourse)}<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <polyline points="9 18 15 12 9 6"></polyline>
                </svg>
              </a>
...
<!-- Link Ver Todos -->
    ...
    <section class="section section-alt">
      <div class="container">
        <div class="section-header reveal-on-scroll">
          <h2>${allowBr(dict.home.target.titlePrefix)} <span class="emphasis">${escapeHtml(dict.home.target.titleEmphasis)}</span>${escapeHtml(dict.home.target.titleSuffix)}</h2>
          <p>${escapeHtml(dict.home.target.subtitle)}</p>
        </div>
        ...
        <div class="steps-container reveal-on-scroll">
          <div class="step-card">
            ...
            <h3 style="display: flex; align-items: baseline; gap: 8px;">
              <span class="step-num" style="margin-bottom: 0; font-size: 1.5rem; color: var(--text-muted);">${escapeHtml(dict.home.target.steps[0].num)}</span>
              ${escapeHtml(dict.home.target.steps[0].title)}
            </h3>
            <p>${escapeHtml(dict.home.target.steps[0].desc)}</p>
          </div>
          <div class="step-card">
            <div style="margin-bottom: 24px; color: var(--brand-blue);">
              <svg aria-hidden="true" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            ...
            <h3 style="display: flex; align-items: baseline; gap: 8px;">
              <span class="step-num" style="margin-bottom: 0; font-size: 1.5rem; color: var(--text-muted);">${escapeHtml(dict.home.target.steps[1].num)}</span>
              ${escapeHtml(dict.home.target.steps[1].title)}
            </h3>
            <p>${escapeHtml(dict.home.target.steps[1].desc)}
            </p>
          </div>
          <div class="step-card">
            <div style="margin-bottom: 24px; color: var(--brand-blue);">
            ...
            <h3 style="display: flex; align-items: baseline; gap: 8px;">
              <span class="step-num" style="margin-bottom: 0; font-size: 1.5rem; color: var(--text-muted);">${escapeHtml(dict.home.target.steps[2].num)}</span>
              ${escapeHtml(dict.home.target.steps[2].title)}
            </h3>
            <p>${escapeHtml(dict.home.target.steps[2].desc)}</p>
          </div>
        </div>
      </div>
    </section>

    <!-- 4. ${escapeHtml(dict.common.nav.trilhas)} -->
      ...
      <div class="reveal-on-scroll"
        ...
        <div class="trilhas-top-grid">
              ...
              <div style="display: flex; gap: 24px; margin-bottom: 24px; position: relative; z-index: 2;">
                ...
                <div
                  ...
                  <div
                    ...
                    ${escapeHtml(dict.home.trilhas.mockUi.course1)}</div>
                  <h4
                    style="font-family: 'Outfit', sans-serif; font-size: 1rem; margin: 0 0 8px 0; color: var(--brand-black);">
                    ${escapeHtml(dict.home.trilhas.mockUi.course1Title)}</h4>
                  <div style="display: flex; align-items: center; gap: 8px;">
                    ...
                    <span
                      style="font-family: 'JetBrains Mono', monospace; font-size: 0.7rem; color: #10B981; font-weight: bold;">${escapeHtml(dict.home.trilhas.mockUi.completed)}</span>
                  </div>
                </div>
              </div>
              ...
              <div style="display: flex; gap: 24px; margin-bottom: 24px; position: relative; z-index: 2;">
                ...
                <div
                  ...
                  <div
                    ...
                    ${escapeHtml(dict.home.trilhas.mockUi.course2)}</div>
                  <h4
                    style="font-family: 'Outfit', sans-serif; font-size: 1rem; margin: 0 0 8px 0; color: var(--brand-black);">
                    ${escapeHtml(dict.home.trilhas.mockUi.course2Title)}</h4>
                  <div style="display: flex; align-items: center; gap: 8px;">
                    <div style="height: 4px; background: #E2E8F0; border-radius: 2px; flex-grow: 1;">
                      <div style="width: 30%; height: 100%; background: var(--brand-blue); border-radius: 2px;"></div>
                    </div>
                    <span
                      style="font-family: 'JetBrains Mono', monospace; font-size: 0.7rem; color: var(--brand-gray);">${escapeHtml(dict.home.trilhas.mockUi.remaining)}</span>
                  </div>
                </div>
              </div>
              ...
              <div style="display: flex; gap: 24px; position: relative; z-index: 2;">
                ...
                <div style="background: transparent; padding: 6px 16px; flex-grow: 1; opacity: 0.6;">
                  <h4
                    ...
                    ${escapeHtml(dict.home.trilhas.mockUi.certificateTitle)}</h4>
                  <div style="font-family: 'Hanken Grotesk', sans-serif; font-size: 0.85rem; color: var(--brand-gray);">
                    ${escapeHtml(dict.home.trilhas.mockUi.certificateDesc)}</div>
                </div>
              </div>
          ...
          <div style="display: flex; flex-direction: column; gap: 16px;">
            <h2 style="font-size: 2.5rem; margin: 0; letter-spacing: -0.02em; line-height: 1.15;">${escapeHtml(dict.home.trilhas.title)}</h2>
            <p style="color: var(--text-muted); font-size: 1.1rem; line-height: 1.6; margin: 0;">${escapeHtml(dict.home.trilhas.subtitle)}</p>
          </div>
        ...
        <div class="trilhas-bottom-grid">
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <h4 style="font-size: 1.2rem; margin: 0;">${escapeHtml(dict.home.trilhas.features[0].title)}</h4>
            </div>
            <p style="color: var(--text-muted); font-size: 1rem; line-height: 1.5; margin: 0;">${escapeHtml(dict.home.trilhas.features[0].desc)}</p>
          </div>
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <h4 style="font-size: 1.2rem; margin: 0;">${escapeHtml(dict.home.trilhas.features[1].title)}</h4>
            </div>
            <p style="color: var(--text-muted); font-size: 1rem; line-height: 1.5; margin: 0;">${escapeHtml(dict.home.trilhas.features[1].desc)}</p>
          </div>

          <!-- Item 3 -->
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <div style="display: flex; align-items: center; min-height: 28px;">
              <img src="/img/JilsonAI.png" alt="${escapeHtml(dict.home.trilhas.features[2].title)}" style="height: 22px; width: auto; object-fit: contain;">
            </div>
            <p style="color: var(--text-muted); font-size: 1rem; line-height: 1.5; margin: 0;">${escapeHtml(dict.home.trilhas.features[2].desc)}</p>
          </div>
          ...
          <div style="display: flex; flex-direction: column; gap: 20px;">
            <div style="display: flex; align-items: center; gap: 10px;">
              ...
              <h4 style="font-size: 1.2rem; margin: 0;">${escapeHtml(dict.home.trilhas.features[3].title)}</h4>
            </div>
            <p style="color: var(--text-muted); font-size: 1rem; line-height: 1.5; margin: 0;">${escapeHtml(dict.home.trilhas.features[3].desc)}</p>
          </div>
        ...
        <div style="display: flex; justify-content: center; margin-top: 16px;">
          <button ${canSubscribe ? "" : "disabled"} class="btn"
            style="padding: 14px 32px; font-size: 1.05rem; border-radius: 40px; box-shadow: 0 4px 12px rgba(0, 113, 227, 0.3);">${escapeHtml(dict.home.trilhas.viewAll)}</button>
        </div>
      </div>
    </section>

    <!-- 5. ${escapeHtml(dict.home.trilhas.features[2].title)} -->
    <section class="section container" style="padding-top: 0;">
      <div class="ai-container reveal-on-scroll">
        ...
        <div class="ai-content">
          ...
          <h2 style="font-size: clamp(2.5rem, 4vw, 3rem);">${allowBr(dict.home.ai.titlePrefix)} <span
              class="emphasis">${escapeHtml(dict.home.ai.titleEmphasis)}</span>${escapeHtml(dict.home.ai.titleSuffix)}</h2>
          <p style="font-size: 1rem; margin-bottom: 40px; max-width: 600px;">${escapeHtml(dict.home.ai.subtitle)}</p>

          <ul class="ai-features-list">
${dict.home.ai.features.map((f) => `            <li>
        ...
        <div class="ai-visual">
          <!-- O Widget Interativo "${escapeHtml(dict.home.trilhas.features[2].title)}" -->
          <div class="ai-glass-panel chat-panel">

            <!-- Chat Header -->
            <div class="chat-header">
              <img src="/img/Jilson-Santana.png" alt="${escapeHtml(dict.home.a11y.chatAvatar)}"
              ...
              <div class="chat-header-info">
                <h4>JilsonAI</h4>
                <span>${escapeHtml(dict.home.ai.chatMock.status)}</span>
              </div>
            </div>
            ...
            <div class="chat-messages" id="ai-chat-messages">
              <div class="chat-bubble user">
                ${escapeHtml(dict.home.ai.chatMock.userMsg)}
              </div>

              <div class="chat-bubble ai">
                ${escapeHtml(dict.home.ai.chatMock.aiMsg)}
              </div>
            ...
            <div class="chat-footer">
              <div class="chat-input-mock">
                <span>${escapeHtml(dict.home.ai.chatMock.placeholder)}</span>
    ...
    <section class="section section-alt">
      <div class="container author-section">
        ...
        <div class="author-content">
          <h2>${escapeHtml(dict.home.author.titlePrefix)} <span class="emphasis">${escapeHtml(dict.home.author.titleEmphasis)}</span>${escapeHtml(dict.home.author.titleSuffix)}</h2>
          <p>${escapeHtml(dict.home.author.subtitle)}</p>

          <div class="author-credentials">
            <span>${escapeHtml(dict.home.author.credentials[0])}</span>
            <span>${escapeHtml(dict.home.author.credentials[1])}</span>
          </div>

          <p
            style="font-size: 1.15rem; color: var(--text-main); font-weight: 500; line-height: 1.6; margin-bottom: 32px; font-style: italic;">
            ${escapeHtml(dict.home.author.quote)}</p>

          <div class="stat-row">
            <div class="stat-item">
              <strong>${escapeHtml(dict.home.author.stats[0].value)}</strong>
              <span>${escapeHtml(dict.home.author.stats[0].label)}</span>
            </div>
            <div class="stat-item">
              <strong>${escapeHtml(dict.home.author.stats[1].value)}</strong>
              <span>${escapeHtml(dict.home.author.stats[1].label)}</span>
            </div>
            <div class="stat-item">
              <strong>${escapeHtml(dict.home.author.stats[2].value)}</strong>
              <span>${escapeHtml(dict.home.author.stats[2].label)}</span>
            </div>
          </div>
        </div>
      </div>
...
${dict.home.testimonials.list.map((t) => `        <div class="test-card">
    ...
    <section id="assine" class="section section-alt">
      <div class="container">
        <div class="section-header">
          <h2>${escapeHtml(dict.home.pricing.titlePrefix)} <span class="emphasis">${escapeHtml(dict.home.pricing.titleEmphasis)}</span>${escapeHtml(dict.home.pricing.titleSuffix)}</h2>
        </div>

        <div class="pricing-grid" style="grid-template-columns: 1fr; max-width: 460px;">
          <!-- ${escapeHtml(dict.home.pricing.monthlyTitle)} -->
          <div class="price-card featured" style="padding-top: 48px;">
            <h3>${escapeHtml(dict.home.pricing.monthlyTitle)}</h3>
            ...
            <div
              ...
              ${escapeHtml(dict.home.pricing.discountBadge)}
            </div>
            ...
            <ul class="price-list">
              ...
              <li>${escapeHtml(dict.home.pricing.features[1])}</li>
              <li>${escapeHtml(dict.home.pricing.features[2])}</li>
              <li>${escapeHtml(dict.home.pricing.features[3])}</li>
              <li>${escapeHtml(dict.home.pricing.features[4])}</li>
            </ul>
          </div>
        </div>

        <p style="text-align: center; color: var(--text-muted); margin-top: 48px; font-size: 1.1rem;">${escapeHtml(dict.home.pricing.footer)}</p>
      </div>
    </section>
  ...
  <footer class="site-footer">
    <div class="footer-inner">
      ...
      <div class="footer-bottom">
        <div>${escapeHtml(dict.common.footer.tagline)}</div>
        <div>${escapeHtml(dict.common.footer.copyright)}</div>
      </div>
    </div>
  </footer>
